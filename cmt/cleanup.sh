...
${CMTROOT}/mgr/cmt cleanup -sh -pack=CCQENuNeutron -version=${MINERVA_RELEASE} -path=/minerva/app/users/tejinc/cmtuser/Minerva_v22r1p1_NC_cvmfs/Ana $* >${tempfile}; . ${tempfile}
/bin/rm -f ${tempfile}
