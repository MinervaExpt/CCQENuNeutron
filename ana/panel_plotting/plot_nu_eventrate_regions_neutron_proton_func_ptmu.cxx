...
void Draw1DHistograms( TFile *f_orig, TFile* f_signal_weighted, string sample );
...
void Draw1DHistograms(  TFile *f_orig, TFile* f_signal_weighted, string sample, string yvar="q2qe" )
{
  ...
  MnvH2D *h_dpty_yvar[nHistos], *h_dptx_yvar[nHistos], *h_dpt_yvar[nHistos], 
         *h_pn_yvar[nHistos], *h_dalphat_yvar[nHistos], *h_dphit_yvar[nHistos],
         *h_dthetaP_yvar[nHistos], *h_dthetaR_yvar[nHistos], *h_ptheta_yvar[nHistos],
         *h_dtheta2D_yvar[nHistos],
         *h_muontheta_yvar[nHistos],*h_muonmomentum_yvar[nHistos],
         *h_enu_yvar[nHistos];
      

  utils->bookHistos( f1, h_dpt_yvar,          Form( "h_dpt_%s", yvar.c_str() ) );
  utils->bookHistos( f1, h_dptx_yvar,         Form( "h_dptx_%s", yvar.c_str() ) );
  utils->bookHistos( f1, h_dpty_yvar,         Form( "h_dpty_%s", yvar.c_str() ) );

  utils->bookHistos( f1, h_pn_yvar,           Form( "h_pn_%s", yvar.c_str() ) );
  utils->bookHistos( f1, h_dalphat_yvar,      Form( "h_dalphat_%s", yvar.c_str() ) );
  utils->bookHistos( f1, h_dphit_yvar,        Form( "h_dphit_%s", yvar.c_str() ) );

  utils->bookHistos( f1, h_dthetaP_yvar,      Form( "h_dthetaP_%s", yvar.c_str() ) );
  utils->bookHistos( f1, h_dthetaR_yvar,      Form( "h_dthetaR_%s", yvar.c_str() ) );
  utils->bookHistos( f1, h_ptheta_yvar,       Form( "h_ptheta_%s", yvar.c_str() ) );

  utils->bookHistos( f1, h_dtheta2D_yvar,     Form( "h_dtheta2D_%s", yvar.c_str() ) );
  cout<<"booking muon"<<endl;
  utils->bookHistos( f1, h_muontheta_yvar,    Form( "h_muontheta_%s", yvar.c_str() ) );
  utils->bookHistos( f1, h_muonmomentum_yvar, Form( "h_muonmomentum_%s", yvar.c_str() ) );
  utils->bookHistos( f1, h_enu_yvar,          Form( "h_enu_%s", yvar.c_str() ) );

  putils->scaleMCHistos(  h_dpt_yvar,    pot_norm );
  putils->scaleMCHistos(  h_dptx_yvar,   pot_norm );
  putils->scaleMCHistos(  h_dpty_yvar,   pot_norm );
  putils->scaleMCHistos(  h_pn_yvar,     pot_norm );
  putils->scaleMCHistos(  h_dalphat_yvar,pot_norm );
  putils->scaleMCHistos(  h_dphit_yvar,  pot_norm );
  putils->scaleMCHistos(  h_dthetaP_yvar,pot_norm );
  putils->scaleMCHistos(  h_dthetaR_yvar,pot_norm );
  putils->scaleMCHistos(  h_ptheta_yvar, pot_norm );
  putils->scaleMCHistos(  h_muontheta_yvar, pot_norm );
  putils->scaleMCHistos(  h_muonmomentum_yvar, pot_norm );
  putils->scaleMCHistos(  h_enu_yvar, pot_norm );
  string axis = "x";
  ...
  draw1DDistro( h_dpt_yvar, fits, putils, "plot-1d-dpt", pot_data, pot_mc, "x", "#delta p_{T} (GeV/c)", "Event Rate", 0,0,0);
  draw1DDistro( h_dpt_yvar, fits, putils, "plot-1d-dpt", pot_data, pot_mc, "x", "#delta p_{T} (GeV/c)", "Event Rate", 0,1,0);
  draw1DDistro( h_dpt_yvar, fits, putils, "plot-1d-dpt", pot_data, pot_mc, "x", "#delta p_{T} (GeV/c)", "Event Rate", 0,1,1);
  draw1DDistro( h_dpt_yvar, fits, putils, "plot-1d-dpt", pot_data, pot_mc, "x", "#delta p_{T} (GeV/c)", "Ratio To MC", 1,1,1);
  draw1DDistro( h_dpt_yvar, fits, putils, "plot-1d-dpt", pot_data, pot_mc, "x", "#delta p_{T} (GeV/c)", "Event Rate", 0,1,1,1);
  draw1DDistro( h_dpt_yvar, fits, putils, "plot-1d-dpt", pot_data, pot_mc, "x", "#delta p_{T} (GeV/c)", "Ratio To MC", 1,1,1,1);

  //fits =  GetFitsHisto(f2, "dptx");
  draw1DDistro( h_dptx_yvar, fits, putils, "plot-1d-dptx", pot_data, pot_mc, "x", "#delta p_{Tx} (GeV/c)", "Event Rate", 0,0,0);
  draw1DDistro( h_dptx_yvar, fits, putils, "plot-1d-dptx", pot_data, pot_mc, "x", "#delta p_{Tx} (GeV/c)", "Event Rate", 0,1,0);
  draw1DDistro( h_dptx_yvar, fits, putils, "plot-1d-dptx", pot_data, pot_mc, "x", "#delta p_{Tx} (GeV/c)", "Event Rate", 0,1,1);
  draw1DDistro( h_dptx_yvar, fits, putils, "plot-1d-dptx", pot_data, pot_mc, "x", "#delta p_{Tx} (GeV/c)", "Ratio To MC", 1,1,1);
  draw1DDistro( h_dptx_yvar, fits, putils, "plot-1d-dptx", pot_data, pot_mc, "x", "#delta p_{Tx} (GeV/c)", "Event Rate", 0,1,1,1);
  draw1DDistro( h_dptx_yvar, fits, putils, "plot-1d-dptx", pot_data, pot_mc, "x", "#delta p_{Tx} (GeV/c)", "Ratio To MC", 1,1,1,1);

  //fits =  GetFitsHisto(f2, "dpty");
  draw1DDistro( h_dpty_yvar, fits, putils, "plot-1d-dpty", pot_data, pot_mc, "x", "#delta p_{Ty} (GeV/c)", "Event Rate", 0,0,0);
  draw1DDistro( h_dpty_yvar, fits, putils, "plot-1d-dpty", pot_data, pot_mc, "x", "#delta p_{Ty} (GeV/c)", "Event Rate", 0,1,0);
  draw1DDistro( h_dpty_yvar, fits, putils, "plot-1d-dpty", pot_data, pot_mc, "x", "#delta p_{Ty} (GeV/c)", "Event Rate", 0,1,1);
  draw1DDistro( h_dpty_yvar, fits, putils, "plot-1d-dpty", pot_data, pot_mc, "x", "#delta p_{Ty} (GeV/c)", "Ratio To MC", 1,1,1);
  draw1DDistro( h_dpty_yvar, fits, putils, "plot-1d-dpty", pot_data, pot_mc, "x", "#delta p_{Ty} (GeV/c)", "Event Rate", 0,1,1,1);
  draw1DDistro( h_dpty_yvar, fits, putils, "plot-1d-dpty", pot_data, pot_mc, "x", "#delta p_{Ty} (GeV/c)", "Ratio To MC", 1,1,1,1);

  //fits =  GetFitsHisto(f2, "pn");
  draw1DDistro( h_pn_yvar, fits, putils, "plot-1d-pn", pot_data, pot_mc, "x", "p_{n} (GeV/c)", "Event Rate", 0,0,0);
  draw1DDistro( h_pn_yvar, fits, putils, "plot-1d-pn", pot_data, pot_mc, "x", "p_{n} (GeV/c)", "Event Rate", 0,1,0);
  draw1DDistro( h_pn_yvar, fits, putils, "plot-1d-pn", pot_data, pot_mc, "x", "p_{n} (GeV/c)", "Event Rate", 0,1,1);
  draw1DDistro( h_pn_yvar, fits, putils, "plot-1d-pn", pot_data, pot_mc, "x", "p_{n} (GeV/c)", "Ratio To MC", 1,1,1);
  draw1DDistro( h_pn_yvar, fits, putils, "plot-1d-pn", pot_data, pot_mc, "x", "p_{n} (GeV/c)", "Event Rate", 0,1,1,1);
  draw1DDistro( h_pn_yvar, fits, putils, "plot-1d-pn", pot_data, pot_mc, "x", "p_{n} (GeV/c)", "Ratio To MC", 1,1,1,1);

  //fits =  GetFitsHisto(f2, "dalphat");
  draw1DDistro( h_dalphat_yvar, fits, putils, "plot-1d-dalphat", pot_data, pot_mc, "x", "#delta#alpha_{T} (degree)", "Event Rate", 0,0,0);
  draw1DDistro( h_dalphat_yvar, fits, putils, "plot-1d-dalphat", pot_data, pot_mc, "x", "#delta#alpha_{T} (degree)", "Event Rate", 0,1,0);
  draw1DDistro( h_dalphat_yvar, fits, putils, "plot-1d-dalphat", pot_data, pot_mc, "x", "#delta#alpha_{T} (degree)", "Event Rate", 0,1,1);
  draw1DDistro( h_dalphat_yvar, fits, putils, "plot-1d-dalphat", pot_data, pot_mc, "x", "#delta#alpha_{T} (degree)", "Ratio To MC", 1,1,1);
  draw1DDistro( h_dalphat_yvar, fits, putils, "plot-1d-dalphat", pot_data, pot_mc, "x", "#delta#alpha_{T} (degree)", "Event Rate", 0,1,1,1);
  draw1DDistro( h_dalphat_yvar, fits, putils, "plot-1d-dalphat", pot_data, pot_mc, "x", "#delta#alpha_{T} (degree)", "Ratio To MC", 1,1,1,1);

  //fits =  GetFitsHisto(f2, "dtheta2D");
  draw1DDistro( h_dtheta2D_yvar, fits, putils, "plot-1d-dtheta2D", pot_data, pot_mc, "x", "#delta#theta_{2D} (degree)", "Event Rate", 0,0,0);
  draw1DDistro( h_dtheta2D_yvar, fits, putils, "plot-1d-dtheta2D", pot_data, pot_mc, "x", "#delta#theta_{2D} (degree)", "Event Rate", 0,1,0);
  draw1DDistro( h_dtheta2D_yvar, fits, putils, "plot-1d-dtheta2D", pot_data, pot_mc, "x", "#delta#theta_{2D} (degree)", "Event Rate", 0,1,1);
  draw1DDistro( h_dtheta2D_yvar, fits, putils, "plot-1d-dtheta2D", pot_data, pot_mc, "x", "#delta#theta_{2D} (degree)", "Ratio To MC", 1,1,1);
  draw1DDistro( h_dtheta2D_yvar, fits, putils, "plot-1d-dtheta2D", pot_data, pot_mc, "x", "#delta#theta_{2D} (degree)", "Event Rate", 0,1,1,1);
  draw1DDistro( h_dtheta2D_yvar, fits, putils, "plot-1d-dtheta2D", pot_data, pot_mc, "x", "#delta#theta_{2D} (degree)", "Ratio To MC", 1,1,1,1);

  //fits =  GetFitsHisto(f2, "muontheta");
  draw1DDistro( h_muontheta_yvar, fits, putils, "plot-1d-muontheta", pot_data, pot_mc, "x", "#delta#theta (degree)", "Event Rate", 0,0,0);
  draw1DDistro( h_muontheta_yvar, fits, putils, "plot-1d-muontheta", pot_data, pot_mc, "x", "#delta#theta (degree)", "Event Rate", 0,1,0);
  draw1DDistro( h_muontheta_yvar, fits, putils, "plot-1d-muontheta", pot_data, pot_mc, "x", "#delta#theta (degree)", "Event Rate", 0,1,1);
  draw1DDistro( h_muontheta_yvar, fits, putils, "plot-1d-muontheta", pot_data, pot_mc, "x", "#delta#theta (degree)", "Ratio To MC", 1,1,1);
  draw1DDistro( h_muontheta_yvar, fits, putils, "plot-1d-muontheta", pot_data, pot_mc, "x", "#delta#theta (degree)", "Event Rate", 0,1,1,1);
  draw1DDistro( h_muontheta_yvar, fits, putils, "plot-1d-muontheta", pot_data, pot_mc, "x", "#delta#theta (degree)", "Ratio To MC", 1,1,1,1);

  //fits =  GetFitsHisto(f2, "muonmomentum");
  draw1DDistro( h_muonmomentum_yvar, fits, putils, "plot-1d-muonmomentum", pot_data, pot_mc, "x", "p_{#mu} (GeV/c)", "Event Rate", 0,0,0,0, 0,20);
  draw1DDistro( h_muonmomentum_yvar, fits, putils, "plot-1d-muonmomentum", pot_data, pot_mc, "x", "p_{#mu} (GeV/c)", "Event Rate", 0,1,0,0, 0,20);
  draw1DDistro( h_muonmomentum_yvar, fits, putils, "plot-1d-muonmomentum", pot_data, pot_mc, "x", "p_{#mu} (GeV/c)", "Event Rate", 0,1,1,0, 0,20);
  draw1DDistro( h_muonmomentum_yvar, fits, putils, "plot-1d-muonmomentum", pot_data, pot_mc, "x", "p_{#mu} (GeV/c)", "Ratio To MC",1,1,1,0, 0,20);
  draw1DDistro( h_muonmomentum_yvar, fits, putils, "plot-1d-muonmomentum", pot_data, pot_mc, "x", "p_{#mu} (GeV/c)", "Event Rate", 0,1,1,1, 0,20);
  draw1DDistro( h_muonmomentum_yvar, fits, putils, "plot-1d-muonmomentum", pot_data, pot_mc, "x", "p_{#mu} (GeV/c)", "Ratio To MC",1,1,1,1, 0,20);

  draw1DDistro( h_enu_yvar, fits, putils, "plot-1d-enu", pot_data, pot_mc, "x", "E_{#nu} (GeV)", "Event Rate", 0,0,0,0, 0,20);
  draw1DDistro( h_enu_yvar, fits, putils, "plot-1d-enu", pot_data, pot_mc, "x", "E_{#nu} (GeV)", "Event Rate", 0,1,0,0, 0,20);
  draw1DDistro( h_enu_yvar, fits, putils, "plot-1d-enu", pot_data, pot_mc, "x", "E_{#nu} (GeV)", "Event Rate", 0,1,1,0, 0,20);
  draw1DDistro( h_enu_yvar, fits, putils, "plot-1d-enu", pot_data, pot_mc, "x", "E_{#nu} (GeV)", "Ratio To MC",1,1,1,0, 0,20);
  draw1DDistro( h_enu_yvar, fits, putils, "plot-1d-enu", pot_data, pot_mc, "x", "E_{#nu} (GeV)", "Event Rate", 0,1,1,1, 0,20);
  draw1DDistro( h_enu_yvar, fits, putils, "plot-1d-enu", pot_data, pot_mc, "x", "E_{#nu} (GeV)", "Ratio To MC",1,1,1,1, 0,20);
  ...
  //}
  draw1DDistro( h_dphit_yvar, fits, putils, "plot-1d-dphit", pot_data, pot_mc, "x", "#delta#phi_{T} (degree)", "Event Rate", 0,0,0);
  draw1DDistro( h_dphit_yvar, fits, putils, "plot-1d-dphit", pot_data, pot_mc, "x", "#delta#phi_{T} (degree)", "Event Rate", 0,1,0);
  draw1DDistro( h_dphit_yvar, fits, putils, "plot-1d-dphit", pot_data, pot_mc, "x", "#delta#phi_{T} (degree)", "Event Rate", 0,1,1);
  draw1DDistro( h_dphit_yvar, fits, putils, "plot-1d-dphit", pot_data, pot_mc, "x", "#delta#phi_{T} (degree)", "Ratio To MC", 1,1,1);
  draw1DDistro( h_dphit_yvar, fits, putils, "plot-1d-dphit", pot_data, pot_mc, "x", "#delta#phi_{T} (degree)", "Event Rate", 0,1,1,1);
  draw1DDistro( h_dphit_yvar, fits, putils, "plot-1d-dphit", pot_data, pot_mc, "x", "#delta#phi_{T} (degree)", "Ratio To MC", 1,1,1,1);

  //fits =  GetFitsHisto(f2, "dthetaP");
  draw1DDistro( h_dthetaP_yvar, fits, putils, "plot-1d-dthetaP", pot_data, pot_mc, "x", "#delta#theta_{P} (degree)", "Event Rate", 0,0,0);
  draw1DDistro( h_dthetaP_yvar, fits, putils, "plot-1d-dthetaP", pot_data, pot_mc, "x", "#delta#theta_{P} (degree)", "Event Rate", 0,1,0);
  draw1DDistro( h_dthetaP_yvar, fits, putils, "plot-1d-dthetaP", pot_data, pot_mc, "x", "#delta#theta_{P} (degree)", "Event Rate", 0,1,1);
  draw1DDistro( h_dthetaP_yvar, fits, putils, "plot-1d-dthetaP", pot_data, pot_mc, "x", "#delta#theta_{P} (degree)", "Ratio To MC", 1,1,1);
  draw1DDistro( h_dthetaP_yvar, fits, putils, "plot-1d-dthetaP", pot_data, pot_mc, "x", "#delta#theta_{P} (degree)", "Event Rate", 0,1,1,1);
  draw1DDistro( h_dthetaP_yvar, fits, putils, "plot-1d-dthetaP", pot_data, pot_mc, "x", "#delta#theta_{P} (degree)", "Ratio To MC", 1,1,1,1);

  //fits =  GetFitsHisto(f2, "dthetaR");
  draw1DDistro( h_dthetaR_yvar, fits, putils, "plot-1d-dthetaR", pot_data, pot_mc, "x", "#delta#theta_{R} (degree)", "Event Rate", 0,0,0);
  draw1DDistro( h_dthetaR_yvar, fits, putils, "plot-1d-dthetaR", pot_data, pot_mc, "x", "#delta#theta_{R} (degree)", "Event Rate", 0,1,0);
  draw1DDistro( h_dthetaR_yvar, fits, putils, "plot-1d-dthetaR", pot_data, pot_mc, "x", "#delta#theta_{R} (degree)", "Event Rate", 0,1,1);
  draw1DDistro( h_dthetaR_yvar, fits, putils, "plot-1d-dthetaR", pot_data, pot_mc, "x", "#delta#theta_{R} (degree)", "Ratio To MC", 1,1,1);
  draw1DDistro( h_dthetaR_yvar, fits, putils, "plot-1d-dthetaR", pot_data, pot_mc, "x", "#delta#theta_{R} (degree)", "Event Rate", 0,1,1,1);
  draw1DDistro( h_dthetaR_yvar, fits, putils, "plot-1d-dthetaR", pot_data, pot_mc, "x", "#delta#theta_{R} (degree)", "Ratio To MC", 1,1,1,1);

  //fits =  GetFitsHisto(f2, "ptheta");
  draw1DDistro( h_ptheta_yvar, fits, putils, "plot-1d-ptheta", pot_data, pot_mc, "x", "#theta_{proton} (degree)", "Event Rate", 0,0,0);
  draw1DDistro( h_ptheta_yvar, fits, putils, "plot-1d-ptheta", pot_data, pot_mc, "x", "#theta_{proton} (degree)", "Event Rate", 0,1,0);
  draw1DDistro( h_ptheta_yvar, fits, putils, "plot-1d-ptheta", pot_data, pot_mc, "x", "#theta_{proton} (degree)", "Event Rate", 0,1,1);
  draw1DDistro( h_ptheta_yvar, fits, putils, "plot-1d-ptheta", pot_data, pot_mc, "x", "#theta_{proton} (degree)", "Ratio To MC", 1,1,1);
  draw1DDistro( h_ptheta_yvar, fits, putils, "plot-1d-ptheta", pot_data, pot_mc, "x", "#theta_{proton} (degree)", "Event Rate", 0,1,1,1);
  draw1DDistro( h_ptheta_yvar, fits, putils, "plot-1d-ptheta", pot_data, pot_mc, "x", "#theta_{proton} (degree)", "Ratio To MC", 1,1,1,1);
}
...
void draw1DDistro( MnvH2D** h, vector<MnvH1D*> &fits, CCQENuPlotUtils* putils, string name, double pot_data, double pot_mc, string axis, string xtitle, string ytitle, bool doRatio, bool doFitting, bool doBckSub, bool subqelike, double min_x, double max_x)
{
  ...
  if(doFitting) ApplyFit( hists, fits );
...
void draw3DChunk( string fullinput, string input_bkg, string sample, bool doFitting, string model )
{
  ...
  if(doFitting) ApplyFit( h_dthetaPdthetaR_q2qe, fits );
...
void drawRegionAnglePlots( TFile* f_region, TFile* f_signal_weight , bool doBckFitting, string sample , string tag)
{
  ...
  if( doBckFitting )
  {
    ...
    {
      ApplyFit( &(hvec_qsqqe[i][0]), fits );
    }
    ApplyFit( &(h_qsq_signal[0]), fits );
    ApplyFit( &(h_qsq_non99[0]), fits );
...
void PlotRecoil( TFile *f_orig, TFile *f_signal_weighted )
{
  ...
  ApplyFit( h_recoil_inc_q2qe, fits );
  doFitting = true;
  drawRecoil( h_recoil_inc_q2qe, doFitting );
...
void drawDiagnostic( MnvH2D** hists, string name, string xtitle, string axis="x", bool doRatio=false, double xmin = 0, double xmax=-1 )
{
...
void NeutronDiagnostics( TFile *f_orig, TFile *f_signal_weighted, string tag = "" )
{
  ...
  ApplyFit( h_blobEnergy_q2qe, fit_blobE );
  ApplyFit( h_blobEnergyLow_q2qe, fit_blobE );
  ApplyFit( h_blobDist_q2qe, fit_blobDist );
  ApplyFit( h_nBlobs_q2qe, fit_q2 );
  ApplyFit( h_n2DBlobs_q2qe, fit_q2 );
  ApplyFit( h_n3DBlobs_q2qe, fit_q2 );
  ApplyFit( h_blobMaxE_q2qe, fit_q2 );
  ApplyFit( h_nClus_q2qe, fit_q2 );
...
void NeutronDiagnostics2( TFile *f_orig, TFile *f_signal_weighted, string tag = "" )
{
  ...
  ApplyFit( h_blobMaxE_q2qe, fit_q2 );
  ApplyFit( h_nClus_q2qe, fit_q2 );
  ApplyFit( h_blobEnergyLow_q2qe, fit_q2 );
