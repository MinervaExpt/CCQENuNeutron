...
do
  ...
  for lam in 390 #550 #550 #400 #500 #400 #320 #230 #550 #2500 #2300 #10 4900000
  do
    ...
    do
      ...
      savefolder=plots/${playlist}${processTag}/cuts${cuts}_2/${tag}/redraw_${sample}_${w}_${lam}/
      echo "Moving to $savefolder"
      mkdir -p $savefolder
