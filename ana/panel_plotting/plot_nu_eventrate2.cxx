...
int main(int argc, char* argv[])
{
  ...
  drawRegionAnglePlots( file_region, file_signal_weighted, true , sideband, "", .0, 10.); //do bck fitting
  drawRegionAnglePlots( file_region, file_signal_weighted, false, sideband, "", .0, 10.); //no bck fitting
