...
void makePlots(bool doMultipliers, bool doTracks, bool doBkgSub, string location)
{
  ...
  MnvH2D* mcMnv_qelike_2p2h = (MnvH2D*)f3.Get("h_recoil_inc_ptmu_qelike_oth");//Get from N track
  MnvH2D* mcMnv_qelike_2p2h_no_lowrec = (MnvH2D*)f4.Get("h_recoil_inc_ptmu_qelike_oth");//Get from N track
  //bkgs
  ...
  double multipliers[]={15, 3, 2, 1,
                        1, 1, 1, 1,
                        2, 4, 15, 50,
			200};

  GridCanvas* gc=plotXAxis1D_Nue(histAndOpts, "Recoil (MeV) ", "P_{t} (GeV)", doMultipliers ? multipliers : NULL);
