...
void DoFit( MnvH2D**h, vector<MnvH2D*>&fits )
{
...
void drawDiagnostic( MnvH2D** hists, string name, string xtitle, string axis="x", bool doRatio=false )
{
...
void NeutronDiagnostics( TFile *f_orig, TFile *f_signal_weighted )
{
  ...
  drawDiagnostic( h_blobEnergy_q2qe, "blobE", "E (MeV)", "x", false );
  drawDiagnostic( h_nonBlobEnergy_q2qe, "nonBlobE", "E (MeV)", "x", false );
  drawDiagnostic( h_blobDist_q2qe, "blobDist", "R (mm)", "x" , false);
  drawDiagnostic( h_n3DBlobs_q2qe, "n3DBlobs", "n 3DBlobs", "x" , false);
  drawDiagnostic( h_n2DBlobs_q2qe, "n2DBlobs", "n 2DBlobs", "x" , false);
  drawDiagnostic( h_nBlobs_q2qe, "nBlobs", "nBlobs", "x" , false);
  drawDiagnostic( h_nBlobs_q2qe, "nBlobs", "nBlobs", "y" , false);
  drawDiagnostic( h_muonTheta_q2qe, "muonTheta", "#theta_{#mu} (degree)", "x" , false);
  drawDiagnostic( h_muonPhi_q2qe, "muonPhi", "#phi_{#mu} (degree)", "x" , false);
  drawDiagnostic( h_muonE_q2qe, "muonE", "E_{#mu} (GeV)", "x" , false);

  drawDiagnostic( h_blobEnergy_q2qe, "blobE", "E (MeV)", "x", true );
  drawDiagnostic( h_nonBlobEnergy_q2qe, "nonBlobE", "E (MeV)", "x", true );
  drawDiagnostic( h_blobDist_q2qe, "blobDist", "R (mm)", "x" , true);
  drawDiagnostic( h_n3DBlobs_q2qe, "n3DBlobs", "n 3DBlobs", "x" , true);
  drawDiagnostic( h_n2DBlobs_q2qe, "n2DBlobs", "n 2DBlobs", "x" , true);
  drawDiagnostic( h_nBlobs_q2qe, "nBlobs", "nBlobs", "x" , true);
  drawDiagnostic( h_nBlobs_q2qe, "nBlobs", "nBlobs", "y" , true);
  drawDiagnostic( h_muonTheta_q2qe, "muonTheta", "#theta_{#mu} (degree)", "x" , true);
  drawDiagnostic( h_muonPhi_q2qe, "muonPhi", "#phi_{#mu} (degree)", "x" , true);
  drawDiagnostic( h_muonE_q2qe, "muonE", "E_{#mu} (GeV)", "x" , true);
