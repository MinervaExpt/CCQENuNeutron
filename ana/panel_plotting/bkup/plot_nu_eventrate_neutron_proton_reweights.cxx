...
int nPlaylists = 1;
void drawPlots(string savename, TH2* data, TH2* dataStat, TH2* mc, TH2* mc_qelike_qe, TH2* mc_qelike_res, TH2* mc_qelike_dis, TH2* mc_qelike_2p2h, string xtitle, string ytitle, string celltitle, string axis="x", double scale =1, double ymin=0, double ymax=2.4, double * multipliers=NULL, bool ratio = false, bool setlogx = false , bool setlogy = false);
...
void makePlots(bool doMultipliers, bool doBkgSub, string fname_signal, string fname_bkg_weight, string var, string sideband="Signal", bool drawRCut=false )
{
  ...
  MnvH2D* h_mc_qelike_qe =    ProjectionHDL( vec_mc_qelike_qe, var+"_qelike_qe", hdl, xbins, ybins,zbins,dims );
  ...
  cout<<"h_mc_qelike_qe has "<<h_mc_qelike_qe->GetVertErrorBandNames().size()<<endl;
  ...
  TH2* mc_qelike_qe= new TH2D( h_mc_qelike_qe->GetCVHistoWithStatError() );
  ...
  drawPlots(savename+doBkg+ext, data,  dataStat,  mc,  mc_qelike_qe,  mc_qelike_res,  mc_qelike_dis,  mc_qelike_2p2h, xtitle, ytitle, celltitle, "x", scale, ymin,ymax, multipliers, false );

  savename =  "plots/nu-2d-evtrate-ratio-model-q2qe-"+var+"-"+sideband;
  ytitle = "Ratio to MnvTune";
  drawPlots(savename+doBkg+ext, data,  dataStat,  mc,  mc_qelike_qe,  mc_qelike_res,  mc_qelike_dis,  mc_qelike_2p2h, xtitle, ytitle, celltitle, "x", scale, -.4,2.4, NULL, true );
  //gc->Print("plots/nu-2d-evtrate-model-q2qe-.png");
  //

  savename =  "plots/nu-2d-evtrate-model-q2qe-equalweighted-"+var+"-"+sideband;
  ytitle =  "Event Rate (#times 10^{-3}) per Degree";
  drawPlots(savename+doBkg+ext, data,  dataStat,  mc_equalweighted,  mc_qelike_qe,  mc_qelike_res,  mc_qelike_dis,  mc_qelike_2p2h, xtitle, ytitle, celltitle, "x", scale, ymin,ymax, multipliers, false );

  savename =  "plots/nu-2d-evtrate-ratio-model-q2qe-equalweighted-"+var+"-"+sideband;
  ytitle =  "Ratio to MnvTune (EqualWeight)";
  drawPlots(savename+doBkg+ext, data,  dataStat,  mc_equalweighted,  mc_qelike_qe,  mc_qelike_res,  mc_qelike_dis,  mc_qelike_2p2h, xtitle, ytitle, celltitle, "x", scale, -.4,2.4, NULL, true );
  ...
  drawPlots(savename+doBkg+ext, data,  dataStat,  mc,  mc_qelike_qe,  mc_qelike_res,  mc_qelike_dis,  mc_qelike_2p2h, xtitle, ytitle, celltitle, "y", scale, ymin,ymax, multipliers2, false,true );

  savename =  "plots/nu-2d-evtrate-ratio-model-"+sideband+"-"+var; 
  if(doCenter) savename+="-center";
  ytitle = "Ratio to MnvTune";
  drawPlots(savename+doBkg+ext, data,  dataStat,  mc,  mc_qelike_qe,  mc_qelike_res,  mc_qelike_dis,  mc_qelike_2p2h, xtitle, ytitle, celltitle, "y", scale, -.4,2.4, NULL, true,true );
  //gc->Print("plots/nu-2d-evtrate-model-q2qe-.png");
  //
  ...
  drawPlots(savename+doBkg+ext, data,  dataStat,  mc_equalweighted,  mc_qelike_qe,  mc_qelike_res,  mc_qelike_dis,  mc_qelike_2p2h, xtitle, ytitle, celltitle, "y", scale, ymin,ymax, multipliers2, false ,true);

  savename =  "plots/nu-2d-evtrate-ratio-model-equalweighted-"+sideband+"-"+var;
  if(doCenter) savename+="-center";
  ytitle =  "Ratio to MnvTune (EqualWeight)";
  drawPlots(savename+doBkg+ext, data,  dataStat,  mc_equalweighted,  mc_qelike_qe,  mc_qelike_res,  mc_qelike_dis,  mc_qelike_2p2h, xtitle, ytitle, celltitle, "y", scale, -.4,2.4, NULL, true ,true);
...
void drawPlots(string savename, TH2* data, TH2* dataStat, TH2* mc, TH2* mc_qelike_qe, TH2* mc_qelike_res, TH2* mc_qelike_dis, TH2* mc_qelike_2p2h, string xtitle, string ytitle, string celltitle, string axis, double scale , double ymin, double ymax, double * multipliers, bool ratio , bool setlogx  , bool setlogy )
{
  ...
  histAndOpts.push_back(std::make_pair( (TH2*) mc_qelike_qe->Clone("mc_qqe"),       "histl"));
