...
cmd="./MuonSelectionHistsMap /minerva/data/users/tejinc/CCQENu/antinu/hists/test_protonSel_minervame1A_new.root minervame1A Signal 0 2 -1 -1 2>&1 >log/proton_minervame1A.log &"
echo $cmd
...
for mode in Signal
do
  cmd="./MuonSelectionHists /minerva/data/users/tejinc/CCQENu/antinu/hists/test_protonSel_minervame1A_new_$mode.root minervame1A $mode 0 2 1 1  "
  echo $cmd
  eval $cmd
done
