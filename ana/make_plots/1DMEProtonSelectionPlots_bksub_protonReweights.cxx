...
int ProtonSelectionPlots( string filename, string filename_sub, string style = "QE")
{
  // read file to get histograms
  cout<<"Begin ProtonSelectionPlots"<<endl;
  bool area_norm  = false;
  TFile *f = new TFile( filename.c_str(), "READ" );
  TFile *f_sub = new TFile( filename_sub.c_str(), "READ" );
  ...
  //---------------------------------------------
  MnvH2D* h_dthetaR_ptmu_2track_signal[nHistos], *h_dthetaR_ptmu_2track_blobs[nHistos], *h_dthetaR_ptmu_2track_michel[nHistos]; 
  MnvH2D* h_tuned_bkg_dthetaR_ptmu_2track_signal,*h_tuned_bkg_dthetaR_ptmu_2track_blobs,*h_tuned_bkg_dthetaR_ptmu_2track_michel;

  MnvH2D* h_dthetaP_ptmu_2track_signal[nHistos], *h_dthetaP_ptmu_2track_blobs[nHistos], *h_dthetaP_ptmu_2track_michel[nHistos]; 
  MnvH2D* h_tuned_bkg_dthetaP_ptmu_2track_signal,*h_tuned_bkg_dthetaP_ptmu_2track_blobs,*h_tuned_bkg_dthetaP_ptmu_2track_michel;
  ...
  utils->bookHistos( f, h_dthetaR_ptmu_2track_signal,"h_dthetaR_ptmu");

  utils->bookHistos( f, h_dthetaP_ptmu_2track_signal,"h_dthetaP_ptmu");
  ...
  //h_dthetaR_ptmu_2track_signal[kQELikeNot]  =   (MnvH2D*) f->Get("h_tuned_bkg_dthetaR_ptmu_2track_signal");  
  //h_dthetaR_ptmu_2track_blobs[kQELikeNot]   =   (MnvH2D*) f->Get("h_tuned_bkg_dthetaR_ptmu_2track_blobs");
  //h_dthetaR_ptmu_2track_michel[kQELikeNot]  =   (MnvH2D*) f->Get("h_tuned_bkg_dthetaR_ptmu_2track_michel");

  //h_dthetaP_ptmu_2track_signal[kQELikeNot]  =   (MnvH2D*) f->Get("h_tuned_bkg_dthetaP_ptmu_2track_signal");  
  //h_dthetaP_ptmu_2track_blobs[kQELikeNot]   =   (MnvH2D*) f->Get("h_tuned_bkg_dthetaP_ptmu_2track_blobs");
  //h_dthetaP_ptmu_2track_michel[kQELikeNot]  =   (MnvH2D*) f->Get("h_tuned_bkg_dthetaP_ptmu_2track_michel");

  //h_dthetaR_ptmu_2track_signal[kData] = (MnvH2D*) f->Get("h_dthetaR_ptmu_data_2track_weighted_bck_signal");
  //h_dthetaR_ptmu_2track_blobs[kData]= (MnvH2D*) f->Get("h_dthetaR_ptmu_data_2track_weighted_bck_blobs");
  //h_dthetaR_ptmu_2track_michel[kData]= (MnvH2D*) f->Get("h_dthetaR_ptmu_data_2track_weighted_bck_michel");
  //h_dthetaR_ptmu_2track_signal[kMC] = (MnvH2D*) f->Get("h_dthetaR_ptmu_mc_2track_weighted_bck_signal");
  //h_dthetaR_ptmu_2track_blobs[kMC]= (MnvH2D*) f->Get("h_dthetaR_ptmu_mc_2track_weighted_bck_blobs");
  //h_dthetaR_ptmu_2track_michel[kMC]= (MnvH2D*) f->Get("h_dthetaR_ptmu_mc_2track_weighted_bck_michel");

  //h_dthetaP_ptmu_2track_signal[kData] = (MnvH2D*) f->Get("h_dthetaP_ptmu_data_2track_weighted_bck_signal");
  //h_dthetaP_ptmu_2track_blobs[kData] = (MnvH2D*) f->Get("h_dthetaP_ptmu_data_2track_weighted_bck_signal");
  //h_dthetaP_ptmu_2track_michel[kData] = (MnvH2D*) f->Get("h_dthetaP_ptmu_data_2track_weighted_bck_signal");
  //h_dthetaP_ptmu_2track_signal[kMC] = (MnvH2D*) f->Get("h_dthetaP_ptmu_mc_2track_weighted_bck_signal");
  //h_dthetaP_ptmu_2track_blobs[kMC] = (MnvH2D*) f->Get("h_dthetaP_ptmu_mc_2track_weighted_bck_signal");
  //h_dthetaP_ptmu_2track_michel[kMC] = (MnvH2D*) f->Get("h_dthetaP_ptmu_mc_2track_weighted_bck_signal");
  ...
  cout<<"Drawn h_dthetaP_signal"<<endl;
...
*/
  ...
  //==================================================
  plotter->DrawDataMCWithErrorBand(h_dthetaR_signal[kData], h_dthetaR_signal[kMC], 1.0, "TR", false, h_dthetaR_signal[kQELikeNot],h_dthetaR_signal[kQELikeNot], area_norm);
  ...
  plotter->DrawDataMCWithErrorBand(h_dthetaP_signal[kData], h_dthetaP_signal[kMC], 1.0, "TR", false,  h_dthetaP_signal[kQELikeNot],h_dthetaP_signal[kQELikeNot], area_norm);
  utils->writeNorm( area_norm, pot_data, pot_mc, true ); 
  ...
  //--------------------------------------------
  plotter->DrawErrorSummary(h_dthetaR_signal[kMC], "TR", true, true, 0.00001, area_norm );
  ...
  plotter->DrawErrorSummary(h_dthetaP_signal[kMC], "TR", true, true, 0.00001, area_norm );
  ...
  plotter->DrawErrorSummary(h_dthetaR_signal[kMC], "TL", false, true, 0.00001, area_norm, "Muon Reconstruction" );
  utils->Print( c, Form("ProtonSelection%s/h_dthetaR_signal_with_sys_errorsummary_muonRecon_%s_%s",  "Signal", "2", "pot" ) );
  plotter->DrawErrorSummary(h_dthetaP_signal[kMC], "TL", false, true, 0.00001, area_norm, "Muon Reconstruction" );
  utils->Print( c, Form("ProtonSelection%s/h_dthetaP_signal_with_sys_errorsummary_muonRecon_%s_%s",  "Signal", "2", "pot" ) );
  ...
  plotter->axis_maximum_group = 2000; 

  plotter->DrawErrorSummary(h_dthetaR_signal[kMC], "TL", false, true, 0.00001, area_norm, "Flux", false );
  utils->Print( c, Form("ProtonSelection%s/h_dthetaR_signal_with_sys_errorsummary_muonRecon_%s_%s",  "Signal", "2", "pot" ) );
  plotter->DrawErrorSummary(h_dthetaP_signal[kMC], "TL", false, true, 0.00001, area_norm, "Flux", false );
  utils->Print( c, Form("ProtonSelection%s/h_dthetaP_signal_with_sys_errorsummary_muonRecon_%s_%s",  "Signal", "2", "pot" ) );
