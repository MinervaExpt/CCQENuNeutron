...
int NeutronSelectionPlots( string filename, bool area_norm = false, string style = "QE")
{
  ...
  utils->Print(c, Form("NeutronSelection%s/muon_neutron_dperp_qsq_mc_rawEvts_colz_logz_%s_%s", sample.Data(), multiplicity_label.Data(), norm.Data()) );
  ...
  plotter->AddPlotLabel( toplabel.Data(), 0.285, 0.93, 0.033 );
  plotter->AddPlotLabel( "MINER#nuA Preliminary", 0.6, 0.93, 0.033, kBlue, 32, 11 );
  utils->Print(c, Form("NeutronSelection%s/muon_neutron_dperp_qsq_mc_rawEvts_qeh_ratio_colz_logz_%s_%s", sample.Data(), multiplicity_label.Data(), norm.Data()) );
  ...
  plotter->AddPlotLabel( toplabel.Data(), 0.285, 0.93, 0.033 );
  plotter->AddPlotLabel( "MINER#nuA Preliminary", 0.6, 0.93, 0.033, kBlue, 32, 11 );
  utils->Print(c, Form("NeutronSelection%s/muon_neutron_dperp_qsq_data_rawEvts_colz_logz_%s_%s", sample.Data(), multiplicity_label.Data(), norm.Data()) );
  ...
  plotter->AddPlotLabel( toplabel.Data(), 0.285, 0.93, 0.033 );
  plotter->AddPlotLabel( "MINER#nuA Preliminary", 0.6, 0.93, 0.033, kBlue, 32, 11 );
  utils->Print(c, Form("NeutronSelection%s/muon_neutron_dperp_qsq_data_fracStatError_colz_%s_%s", sample.Data(), multiplicity_label.Data(), norm.Data()) );
  ...
  plotter->AddPlotLabel( toplabel.Data(), 0.285, 0.93, 0.033 );
  plotter->AddPlotLabel( "MINER#nuA Preliminary", 0.6, 0.93, 0.033, kBlue, 32, 11 );
  utils->Print(c, Form("NeutronSelection%s/muon_neutron_dperp_dreactplane_mc_rawEvts_colz_logz_%s_%s", sample.Data(), multiplicity_label.Data(), norm.Data()) );
  ...
  plotter->AddPlotLabel( toplabel.Data(), 0.285, 0.93, 0.033 );
  plotter->AddPlotLabel( "MINER#nuA Preliminary", 0.6, 0.93, 0.033, kBlue, 32, 11 );
  utils->Print(c, Form("NeutronSelection%s/muon_neutron_dperp_dreactplane_data_rawEvts_colz_logz_%s_%s", sample.Data(), multiplicity_label.Data(), norm.Data()) );
  ...
  plotter->AddPlotLabel( toplabel.Data(), 0.285, 0.93, 0.033 );
  plotter->AddPlotLabel( "MINER#nuA Preliminary", 0.6, 0.93, 0.033, kBlue, 32, 11 );
  utils->Print(c, Form("NeutronSelection%s/muon_neutron_dperp_dreactplane_data_fracStatError_colz_%s_%s", sample.Data(), multiplicity_label.Data(), norm.Data()) );
  ...
  plotter->AddPlotLabel( toplabel.Data(), 0.285, 0.93, 0.033 );
  plotter->AddPlotLabel( "MINER#nuA Preliminary", 0.6, 0.93, 0.033, kBlue, 32, 11 );
  utils->Print(c, Form("NeutronSelection%s/muon_neutron_dreactplane_qsq_mc_rawEvts_colz_logz_%s_%s", sample.Data(), multiplicity_label.Data(), norm.Data()) );
  ...
  plotter->AddPlotLabel( toplabel.Data(), 0.285, 0.93, 0.033 );
  plotter->AddPlotLabel( "MINER#nuA Preliminary", 0.6, 0.93, 0.033, kBlue, 32, 11 );
  utils->Print(c, Form("NeutronSelection%s/muon_neutron_dreactplane_qsq_data_rawEvts_colz_logz_%s_%s", sample.Data(), multiplicity_label.Data(), norm.Data()) );
  ...
  plotter->AddPlotLabel( toplabel.Data(), 0.285, 0.93, 0.033 );
  plotter->AddPlotLabel( "MINER#nuA Preliminary", 0.6, 0.93, 0.033, kBlue, 32, 11 );
  utils->Print(c, Form("NeutronSelection%s/muon_neutron_dreactplane_qsq_data_fracStatError_colz_%s_%s", sample.Data(), multiplicity_label.Data(), norm.Data()) );
  ...
  */
  ...
  plotter->AddPlotLabel(Form("# Hydrogen: %.2f", h_neutron_dperp[kQELike_QE_H]->Integral()), 0.3,0.5,0.033,kBlue,32);
  utils->Print( c, Form("NeutronSelection%s/neutron_dperp_%s_%s", sample.Data(), multiplicity_label.Data(), norm.Data()) );

  utils->drawStacked( h_neutron_phit, style, area_norm, pot_data, pot_mc, includeData );
  plotter->AddPlotLabel(Form("# Hydrogen: %.2f", h_neutron_phit[kQELike_QE_H]->Integral()), 0.3,0.5,0.033,kBlue,32);
  utils->Print( c, Form("NeutronSelection%s/neutron_phit_%s_%s", sample.Data(), multiplicity_label.Data(), norm.Data()) );

  utils->drawStacked( h_neutron_dreactplane, style, area_norm, pot_data, pot_mc, includeData );
  plotter->AddPlotLabel(Form("# Hydrogen: %.2f", h_neutron_dreactplane[kQELike_QE_H]->Integral()), 0.3,0.5,0.033,kBlue,32);
  utils->Print( c, Form("NeutronSelection%s/neutron_dreactplane_%s_%s", sample.Data(), multiplicity_label.Data(), norm.Data()) );

  utils->drawStacked( h_neutron_vtxE, style, area_norm, pot_data, pot_mc, includeData );
  plotter->AddPlotLabel(Form("# Hydrogen: %.2f", h_neutron_vtxE[kQELike_QE_H]->Integral()), 0.3,0.5,0.033,kBlue,32);
  utils->Print( c, Form("NeutronSelection%s/neutron_vtxE_%s_%s", sample.Data(), multiplicity_label.Data(), norm.Data()) );

  utils->drawStacked( h_neutron_dreact_dperpcut, style, area_norm, pot_data, pot_mc, includeData );
  plotter->AddPlotLabel(Form("# Hydrogen: %.2f", h_neutron_dreact_dperpcut[kQELike_QE_H]->Integral()), 0.3,0.5,0.033,kBlue,32);
  utils->Print( c, Form("NeutronSelection%s/neutron_dreact_dperpcut_%s_%s", sample.Data(), multiplicity_label.Data(), norm.Data()) );
  //c->SetLogy(1);
  //utils->drawStacked( h_multiplicity, style, area_norm, pot_data, pot_mc, includeData );
  //utils->Print( c, Form("NeutronSelection%s/multiplicity_%s_%s_logy", sample.Data(), multiplicity_label.Data(), norm.Data()) );
  //c->SetLogy(0);
...
/*
  ...
  utils->Print( c, Form("NeutronSelection%s/q22_bin_%s_%s", sample.Data(), multiplicity_label.Data(), norm.Data()) );
  utils->drawStacked( h_q22_old, style, area_norm, pot_data, pot_mc, includeData );
  utils->Print( c, Form("NeutronSelection%s/q22_old_bin_%s_%s", sample.Data(), multiplicity_label.Data(), norm.Data()) );
*/
  //====================================================================
  ...
  //utils->Print( c, Form("NeutronSelection%s/muon_pt_data_mc_ratio_%s_%s", sample.Data(), multiplicity_label.Data(), norm.Data()) ); 

  plotter->DrawDataMCRatio(h_neutron_dperp[kData], h_neutron_dperp[kMC], 1.0, true, true, -1.5, 1.5, "Data / MC", area_norm);  
  utils->Print( c, Form("NeutronSelection%s/neutron_dperp_mc_ratio_%s_%s", sample.Data(), multiplicity_label.Data(), norm.Data()) ); 
  plotter->DrawDataMCRatio(h_neutron_phit[kData], h_neutron_phit[kMC], 1.0, true, true, -1.5, 1.5, "Data / MC", area_norm);  
  utils->Print( c, Form("NeutronSelection%s/neutron_phit_mc_ratio_%s_%s", sample.Data(), multiplicity_label.Data(), norm.Data()) ); 
  plotter->DrawDataMCRatio(h_neutron_dreactplane[kData], h_neutron_dreactplane[kMC], 1.0, true, true, -1.5, 1.5, "Data / MC", area_norm);  
  utils->Print( c, Form("NeutronSelection%s/neutron_dreactplane_mc_ratio_%s_%s", sample.Data(), multiplicity_label.Data(), norm.Data()) ); 
  ...
  utils->Print( c, Form("NeutronSelection%s/neutron_dperp_with_sys_%s_%s", sample.Data(), multiplicity_label.Data(), norm.Data()) );
...
/*  
  ...
  utils->writeNorm( area_norm, pot_data, pot_mc, true ); 
  utils->Print( c, Form("NeutronSelection%s/muon_pz_with_sys_errorsummary_%s_%s", sample.Data(), multiplicity_label.Data(), norm.Data()) );
  
  plotter->DrawDataMCErrorSummary(h_ptmu_mc_temp, h_ptmu_data_temp, "TR", false, true, 0.00001, area_norm );
  plotter->AddPlotLabel( Form("%s #bullet%s", toplabel.Data(), (area_norm)? "Shape Errors" : "Absolute Errors"), 0.33, 0.94, 0.025 );
  //plotter->AddPlotLabel( "MINER#nuA Preliminary", 0.6, 0.94, 0.03, kBlue, 32, 11 );
  utils->writeNorm( area_norm, pot_data, pot_mc, true ); 
  utils->Print( c, Form("NeutronSelection%s/muon_pt_with_sys_errorsummary_%s_%s", sample.Data(), multiplicity_label.Data(), norm.Data()) );
  
  plotter->DrawDataMCErrorSummary(h_q22[kMC], h_q22[kData], "TR", false, true, 0.00001, area_norm );
  plotter->AddPlotLabel( Form("%s #bullet%s", toplabel.Data(), (area_norm)? "Shape Errors" : "Absolute Errors"), 0.33, 0.94, 0.025 );
  //plotter->AddPlotLabel( "MINER#nuA Preliminary", 0.6, 0.94, 0.03, kBlue, 32, 11 );
  utils->writeNorm( area_norm, pot_data, pot_mc, true );
  utils->Print( c, Form("NeutronSelection%s/q22_with_sys_errorsummary_%s_%s", sample.Data(), multiplicity_label.Data(), norm.Data()) );
*/
  ...
  //utils->Print( c, Form("NeutronSelection%s/muon_pz_with_frac_sys_errorsummary_RecoilRecons_%s_%s", sample.Data(), multiplicity_label.Data(), norm.Data()) );
  
  plotter->axis_maximum_group = 0.2; 
  plotter->DrawErrorSummary(h_neutron_dperp[kMC], "TL", false, true, 0.00001, area_norm, "Muon Reconstruction");
  utils->Print( c, Form("NeutronSelection%s/neutron_dperp_with_frac_sys_errorsummary_MuonRecons_%s_%s", sample.Data(), multiplicity_label.Data(), norm.Data()) );
  
  plotter->axis_maximum_group = 0.2; 
  plotter->DrawErrorSummary(h_neutron_phit[kMC], "TL", false, true, 0.00001, area_norm, "Muon Reconstruction");
  utils->Print( c, Form("NeutronSelection%s/neutron_phit_with_frac_sys_errorsummary_MuonRecons_%s_%s", sample.Data(), multiplicity_label.Data(), norm.Data()) );

  plotter->axis_maximum_group = 0.2; 
  plotter->DrawErrorSummary(h_neutron_dreactplane[kMC], "TL", false, true, 0.00001, area_norm, "Muon Reconstruction");
  utils->Print( c, Form("NeutronSelection%s/neutron_dreactplane_with_frac_sys_errorsummary_MuonRecons_%s_%s", sample.Data(), multiplicity_label.Data(), norm.Data()) );
  ...
  utils->Print( c, Form("NeutronSelection%s/neutron_dperp_with_abs_sys_errorsummary_Flux_%s_%s", sample.Data(), multiplicity_label.Data(), norm.Data()) );
 
  plotter->axis_maximum_group = 2000.0; /*510 for NoFluxConstraint */
  plotter->DrawErrorSummary(h_neutron_phit[kMC], "TL", false, true, 0.00001, area_norm, "Flux", false );
  utils->Print( c, Form("NeutronSelection%s/neutron_phit_with_abs_sys_errorsummary_Flux_%s_%s", sample.Data(), multiplicity_label.Data(), norm.Data()) );
 
  plotter->axis_maximum_group = 2000.0; /*510 for NoFluxConstraint */
  plotter->DrawErrorSummary(h_neutron_dreactplane[kMC], "TL", false, true, 0.00001, area_norm, "Flux", false );
  utils->Print( c, Form("NeutronSelection%s/neutron_dreactplane_with_abs_sys_errorsummary_Flux_%s_%s", sample.Data(), multiplicity_label.Data(), norm.Data()) );
...
void plottingOneInBinsOfAnother( MnvH2D *de2DHisto[], TString plotVariable, TString norm, bool areaNormalizeEntireHisto, MnvPlotter *plotter, CCQENuPlotUtils *utils, string style, bool includeData, TString sample, TString multiplicityLabel, double pot_data, double pot_mc, bool draw_with_sys_band ) {  
  ...
  for( int i=1; i<lastBinNeeded; ++i ) {
    ...
    if( draw_with_sys_band ) { 
      ...
      //(area_norm) ? plotter->WriteNorm("Area Normalized", 0.3, 0.88, 0.045, pot_data) : plotter->AddPOTNormBox(pot_data,pot_mc, 0.3, 0.88); 
      utils->writeNorm( area_norm, pot_data, pot_mc, true ); 
      utils->Print( canv, Form("NeutronSelection%s/muon_%s_In_%sBin_%i_with_sys_%s_%s", sample.Data(), plotVariable.Data(), binVariable.Data(), i, multiplicityLabel.Data(), norm.Data()) ); 
    } else {
      ...
      plotter->AddPlotLabel( Form("%.1f #leq %s < %.1f", lowerBinEdge, binVariable.Data(), upperBinEdge), 0.5, 0.93 );
      utils->writeNorm( area_norm, pot_data, pot_mc, true ); 
      utils->Print( canv, Form("NeutronSelection%s/muon_%s_In_%sBin_%i_splitMC_%s_%s", sample.Data(), plotVariable.Data(), binVariable.Data(), i, multiplicityLabel.Data(), norm.Data()) );  
    }
...
int main( int argc, char *argv[])
{
  ...
  if (argc==1){
    ...
    std::cout<<"MACROS HELP:\n\n"<<
        "\t-./NeutronSelectionPlots path/to/filename Sample Area_Normalize\n\n"<<
  ...
  par.push_back("NeutronSelectionPlots");
  ...
  return NeutronSelectionPlots(par[1], atoi(par[2].c_str()),  par[3]);
}
